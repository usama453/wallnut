          ...
          {!canInvite ? (
            ...
            >
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-full border border-[#222222] bg-[#0a0a0a] px-3.5 py-2 text-[12px] text-[#fbfbfb] transition hover:border-[#2e2e2e] disabled:cursor-progress disabled:opacity-70"
              >
      ...
      {removeTarget ? (
        <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/75 px-4">
          <div
            ...
            className="w-full max-w-[360px] rounded-[10px] border border-[#222222] bg-[#060606] p-5 shadow-[0_24px_48px_rgba(0,0,0,0.55)]"
          >
